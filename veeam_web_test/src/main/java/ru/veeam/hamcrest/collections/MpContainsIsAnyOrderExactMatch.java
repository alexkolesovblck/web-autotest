...
public class MpContainsIsAnyOrderExactMatch extends ru.veeam.hamcrest.MpCollectionCondition {
    protected final List<String> expectedTexts;

    public MpContainsIsAnyOrderExactMatch(String... expectedTexts) {
        this(asList(expectedTexts));
    }

    public MpContainsIsAnyOrderExactMatch(List<String> expectedTexts) {
